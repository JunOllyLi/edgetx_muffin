...
#define FRAME_H_RES  640
#define FRAME_V_RES  480
...
static void processing_task(void *pvParameters)
{
    ...
    uint8_t *jpeg_working_buffer = (uint8_t*)malloc(DECODE_WORKING_BUFFER_SIZE);
...
void usb_uvc_task(void *param)
{
    ...
    fb = (uint16_t*)heap_caps_aligned_alloc(64, FRAME_H_RES * FRAME_V_RES * 2, MALLOC_CAP_INTERNAL);
    if (fb == NULL) {
